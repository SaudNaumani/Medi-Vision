...
from age_regression.reader import read_fn
...
def model_fn(features, labels, mode, params):
    ...
    # 1. create a model and its outputs, from the dltk library for medical image analysis
    # Creates a convolution model type thingy
    ...
    # if its set to predict we dont need an optimizer or loss function
    ...
    # create custom image summaries for tensorboard
    my_image_summaries = {}
...
def train(args):
    ...
    nn = tf.estimator.Estimator(
        ...
        params={"learning_rate": 0.001}, #learning rate explain why you chose this
